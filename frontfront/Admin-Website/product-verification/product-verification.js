...
const PercenttotalProVeri2 = document.getElementById("percent-totalProduct2");
...
async function fetchStats() {
  try {
    ...
    PercenttotalProVeri2.textContent = `${data.percentProducts || 0}% from last month`;
