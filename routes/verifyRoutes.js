...
const { createVerify, getByReg, getAll, getById, updateReg, deleteReg, getStats } = require('../controllers/verifyController.js');
...
router.get('/verifyStats', protect, getStats);
